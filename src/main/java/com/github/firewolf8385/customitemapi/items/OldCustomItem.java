 ...
 */
public class OldCustomItem implements Cloneable {
     ...
     */
    public OldCustomItem(String id) {
        this.id = id;
     ...
     */
    public OldCustomItem setEnchantments(Map<Enchantment, Integer> enchantments) {
        this.enchantments = enchantments;
        return this;
    }

    public OldCustomItem setItem(ItemStack item) {
        this.item = item;
        return this;
    }
     ...
     * @return The Custom Item.
     */
    public OldCustomItem setMaterial(Material material) {
     ...
     * @return The Custom Item.
     */
    public OldCustomItem setRarity(ItemRarity rarity) {
        this.rarity = rarity;
        return this;
    }
     ...
     * @return The Custom Item.
     */
    public OldCustomItem setType(ItemType type) {
        this.type = type;
        return this;
    }
